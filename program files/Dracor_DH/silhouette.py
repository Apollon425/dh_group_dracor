...
def silhouette_plot(data, no_of_clusters):

    range_n_clusters = list(range(2, no_of_clusters+2))
    for n_clusters in range_n_clusters:
        ...
        ax1.set_ylim([0, data.get_shape()[0] + (n_clusters + 1) * 10])  
        ...
        scatter_plot_points = pca.fit_transform(data.toarray())
